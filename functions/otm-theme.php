...
/* Get International Phone Number */
if (!function_exists('otm_shortcode_fax_number')) {
	function otm_shortcode_fax_number()
	{
		return otm_get_option('fax_number');
	}
}
add_shortcode('otm-phone-number-intl', 'otm_shortcode_fax_number');
